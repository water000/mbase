...
.action{width:670px;height:560px;overflow:auto;background-color:#fff;margin:10px auto;cursor:default;}
				...
				<div class="action" style="display: none;">
					...
					<p class=table_title><a href="javascript:;" onclick="open('','', 'width=600,height=400,left=100000,top=100000').document.write(this.parentNode.nextSibling.innerHTML);">Test</a></p><div style="display:none">
					   <!doctype html>
                        ...
                        iframe{border:1px solid #ddd;width:96%;height:18%;overflow:auto;position:fixed;bottom:5px;}
                        iframe .success{width:100%;}
					   ...
					   <p><input value="submit: <?php echo $mbs_appenv->toURL($all_actions[$i]['_name'], $all_actions[$i]['_mod']), '(',CStrTools::txt2html($def[CModDef::P_TLE]),')'?>" onclick="_scale_win();<?php if($include_file) echo 'this.form.enctype=\'multipart/form-data\';'; ?>" style="width:100%;margin:0;" type=submit /></p>
					   </div>
					   </form>
