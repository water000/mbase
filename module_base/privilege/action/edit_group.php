...
<div class="userManager">
	...
	<form name="_form" method="post">
        ...
        <div class="inpBox mb17">
		    ...
		    <label style="margin-right:20px;"><input type=radio name=type value=<?php echo CPrivGroupControl::TYPE_ALLOW?> 
		    	<?php echo isset($args_value['type']) && $args_value['type']==CPrivGroupControl::TYPE_ALLOW ? ' checked':''?> /><?php echo $mbs_appenv->lang('type_allow')?></label>
			<label><input type=radio name=type value=<?php echo CPrivGroupControl::TYPE_DENY?> 
				<?php echo isset($args_value['type']) && $args_value['type']==CPrivGroupControl::TYPE_DENY ? ' checked':''?> /><?php echo $mbs_appenv->lang('type_deny')?></label>
        </div>
        <div class="inpBox mb17">
