...
<style type="text/css">
.left{width:240px;margin:10px 0 0;background-color:#fff;float:left;}
...
.right{position:fixed;width:730px;;min-height:500px;margin:10px 0 0 263px;background-color:#fff;box-shadow:0 2px 6px #313131}
...
.action{overflow:auto;background-color:#fff;margin:10px;cursor:default;}
			...
			<div class=action-item onclick="_action(this)">
				...
				<div class="action" style="display: none;">
					...
					<table cellspacing=0 class=basic_info>
					   <tr><th>Title</th><td><?php echo CStrTools::txt2html($def[CModDef::P_TLE])?></td></tr>
