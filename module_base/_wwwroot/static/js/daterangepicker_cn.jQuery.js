...
jQuery.fn.daterangepicker = function(settings){
	...
	var options = jQuery.extend({
		presetRanges: [
			...
			{text: '近7天', dateStart: 'today-7days', dateEnd: 'today' },
			{text: '当月', dateStart: function(){ return Date.parse('today').moveToFirstDayOfMonth();  }, dateEnd: 'today' },
			{text: '当年', dateStart: function(){ var x= Date.parse('today'); x.setMonth(0); x.setDate(1); return x; }, dateEnd: 'today' },
			//extras:
	...
	var rpPresets = (function(){
		...
		ul.css('width', rangeInput.css('width'));// new line add on 2015/6/18
